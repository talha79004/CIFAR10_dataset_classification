...
# Reshaping test data in the form of 32x32x3 using reshape and rollaxis 
    ...
    v_test2=np.rollaxis(v_test,1,4)
    #print("v_test data shap",v_test2.shape)
...
# Reshaping train data in the form of 32x32x3 using reshape and rollaxis 
    l=len(train_data)
    train_data2=np.array(train_data).reshape(l,3,32,32)
    train_data2=np.rollaxis(train_data2,1,4)
    
# Making label of first class1=0 and class2=1 for test data
    train_label2=[0 if x==class1 else 1 for x in train_label]
    train_label2=np.array(train_label2)

    return train_data2,v_test2,train_label2,v_test_label2


# In[2]:


#Function for getting data of 5 classes
...
# Making label of first class1 = 0, class2 = 1, class3 = 2, class4 = 3 and class5 = 4 for training data
